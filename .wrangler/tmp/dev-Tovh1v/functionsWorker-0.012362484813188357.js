...
// .wrangler/tmp/pages-Uj2cOU/functionsWorker-0.012362484813188357.mjs
...
__name2(readRequiredEnv, "readRequiredEnv");
function parseContactPayload(payload) {
  ...
  const turnstileToken = isNonEmptyString(payload.turnstile_token) ? payload.turnstile_token : "";
  if (!name || !email || !EMAIL_PATTERN.test(email) || !message || message.length > MAX_MESSAGE_LENGTH || !turnstileToken) {
    return null;
  }
  return {
    name,
...
__name(parseContactPayload, "parseContactPayload");
__name2(parseContactPayload, "parseContactPayload");
...
__name2(verifyTurnstileToken, "verifyTurnstileToken");
...
__name2(sendContactEmail, "sendContactEmail");
...
__name2(invalidRequest, "invalidRequest");
...
// .wrangler/tmp/bundle-Q2Zx28/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Q2Zx28/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.012362484813188357.js.map
